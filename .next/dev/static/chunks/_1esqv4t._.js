                ...
                menu.querySelectorAll('a').forEach({
                    "Page.useEffect": (link)=>{
                        link.addEventListener('click', {
                            "Page.useEffect": ()=>toggleMenu(false)
                        }["Page.useEffect"]);
                    }
                }["Page.useEffect"]);
            }
                        ...
                        "Page.useEffect": (entry)=>{
                            if (entry.isIntersecting) {
                                ...
                                if (!span.dataset.done) {
                                    ...
                                    const ease = {
                                        "Page.useEffect.ease": (t)=>1 - Math.pow(1 - t, 3)
                                    }["Page.useEffect.ease"];
                                    const animate = {
                                        "Page.useEffect.animate": (currentTime)=>{
...
_s(Page, "Zgd6LAecrkR+tvdWeSWqCyOgsCw=");
_c = Page;
var _c;
